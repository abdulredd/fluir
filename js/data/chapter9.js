...
const SUBLESSON_9_4 = {
  ...
  vocabulary: [
    { id:'nat9_1',  es:'el alba',         en:'the dawn',           article:'el', gender:'f', plural:'las albas',        ex:'El alba llega a las seis.',         exEn:'Dawn arrives at six.' },
    { id:'nat9_2',  es:'el cielo',        en:'the sky',            article:'el', gender:'m', plural:'los cielos',       ex:'El cielo está azul hoy.',           exEn:'The sky is blue today.' },
    { id:'nat9_3',  es:'la colina',       en:'the hill',           article:'la', gender:'f', plural:'las colinas',      ex:'Hay muchas colinas en el campo.',   exEn:'There are many hills in the country.' },
    { id:'nat9_4',  es:'el desierto',     en:'the desert',         article:'el', gender:'m', plural:'los desiertos',    ex:'El desierto de Sonora es enorme.',  exEn:'The Sonora desert is enormous.' },
    { id:'nat9_5',  es:'la estrella',     en:'the star',           article:'la', gender:'f', plural:'las estrellas',    ex:'Hay muchas estrellas en el cielo.', exEn:'There are many stars in the sky.' },
    { id:'nat9_6',  es:'la inundación',   en:'the flood',          article:'la', gender:'f', plural:'las inundaciones', ex:'La inundación destruyó el pueblo.', exEn:'The flood destroyed the town.' },
    { id:'nat9_7',  es:'el lago',         en:'the lake',           article:'el', gender:'m', plural:'los lagos',        ex:'El lago es muy tranquilo.',         exEn:'The lake is very calm.' },
    { id:'nat9_8',  es:'la lluvia',       en:'the rain',           article:'la', gender:'f', plural:'',                 ex:'Me gusta la lluvia en abril.',      exEn:'I like the rain in April.' },
    { id:'nat9_9',  es:'la luna',         en:'the moon',           article:'la', gender:'f', plural:'',                 ex:'La luna está llena esta noche.',    exEn:'The moon is full tonight.' },
    { id:'nat9_10', es:'la madrugada',    en:'the early morning',  article:'la', gender:'f', plural:'',                 ex:'Llega a las tres de la madrugada.',exEn:'He arrives at three in the morning.' },
    { id:'nat9_11', es:'el mar',          en:'the sea',            article:'el', gender:'m', plural:'los mares',        ex:'El mar está muy calmado hoy.',      exEn:'The sea is very calm today.' },
    { id:'nat9_12', es:'la montaña',      en:'the mountain',       article:'la', gender:'f', plural:'las montañas',     ex:'Las montañas son hermosas.',        exEn:'The mountains are beautiful.' },
    { id:'nat9_13', es:'la nieve',        en:'the snow',           article:'la', gender:'f', plural:'',                 ex:'La nieve cae en diciembre.',        exEn:'Snow falls in December.' },
    { id:'nat9_14', es:'la nube',         en:'the cloud',          article:'la', gender:'f', plural:'las nubes',        ex:'Hay muchas nubes en el cielo.',     exEn:'There are many clouds in the sky.' },
    { id:'nat9_15', es:'el océano',       en:'the ocean',          article:'el', gender:'m', plural:'los océanos',      ex:'El océano Atlántico es enorme.',    exEn:'The Atlantic Ocean is enormous.' },
    { id:'nat9_16', es:'la puesta del sol',en:'the sunset',        article:'la', gender:'f', plural:'',                 ex:'La puesta del sol es hermosa.',     exEn:'The sunset is beautiful.' },
    { id:'nat9_17', es:'el relámpago',    en:'the lightning',      article:'el', gender:'m', plural:'los relámpagos',   ex:'Vi un relámpago en la tormenta.',   exEn:'I saw lightning in the storm.' },
    { id:'nat9_18', es:'el río',          en:'the river',          article:'el', gender:'m', plural:'los ríos',         ex:'El río Amazonas es el más grande.', exEn:'The Amazon river is the largest.' },
    { id:'nat9_19', es:'el sol',          en:'the sun',            article:'el', gender:'m', plural:'',                 ex:'El sol sale a las siete.',          exEn:'The sun rises at seven.' },
    { id:'nat9_20', es:'el temblor',      en:'the tremor',         article:'el', gender:'m', plural:'los temblores',    ex:'Hubo un temblor en la ciudad.',     exEn:'There was a tremor in the city.' },
    { id:'nat9_21', es:'la tempestad',    en:'the storm (tempest)',          article:'la', gender:'f', plural:'las tempestades',  ex:'La tempestad destruyó los árboles.',exEn:'The storm destroyed the trees.' },
    { id:'nat9_22', es:'el terremoto',    en:'the earthquake',     article:'el', gender:'m', plural:'los terremotos',   ex:'El terremoto fue muy fuerte.',      exEn:'The earthquake was very strong.' },
    { id:'nat9_23', es:'la tierra',       en:'the earth / ground', article:'la', gender:'f', plural:'',                 ex:'La tierra está mojada.',            exEn:'The ground is wet.' },
    { id:'nat9_24', es:'la tormenta',     en:'the storm (thunderstorm)',          article:'la', gender:'f', plural:'las tormentas',    ex:'La tormenta llega esta tarde.',     exEn:'The storm arrives this afternoon.' },
    { id:'nat9_25', es:'el trueno',       en:'the thunder',        article:'el', gender:'m', plural:'los truenos',      ex:'Los truenos me despiertan.',        exEn:'Thunder wakes me up.' },
    { id:'nat9_26', es:'el viento',       en:'the wind',           article:'el', gender:'m', plural:'los vientos',      ex:'El viento es muy fuerte hoy.',      exEn:'The wind is very strong today.' },
    { id:'nat9_27', es:'el monte',        en:'the hill / mountain',article:'el', gender:'m', plural:'los montes',       ex:'Hay muchos montes en el norte.',    exEn:'There are many hills in the north.' },
    { id:'nat9_28', es:'el ocaso',        en:'the sunset / dusk',  article:'el', gender:'m', plural:'',                 ex:'El ocaso llega temprano en invierno.',exEn:'Dusk comes early in winter.' },
  ],

  readingVocab: [
    { id:'rv9_1',  es:'aunque',          en:'although / even though' },
    { id:'rv9_2',  es:'libre',           en:'free (available)' },
    { id:'rv9_3',  es:'el sitio',        en:'the place / site' },
    { id:'rv9_4',  es:'el colega',       en:'the colleague' },
    { id:'rv9_5',  es:'el ensayo',       en:'the rehearsal' },
    { id:'rv9_6',  es:'la gira',         en:'the tour' },
    { id:'rv9_7',  es:'de todos modos',  en:'anyway / in any case' },
    { id:'rv9_8',  es:'la ley',          en:'the law' },
    { id:'rv9_9',  es:'las noticias',    en:'the news' },
    { id:'rv9_10', es:'la película',     en:'the film / movie' },
    { id:'rv9_11', es:'el vecino',       en:'the neighbor' },
    { id:'rv9_12', es:'la computadora',  en:'the computer' },
    { id:'rv9_13', es:'el jefe',         en:'the boss' },
    { id:'rv9_14', es:'el espacio',      en:'the space' },
    { id:'rv9_15', es:'la razón',        en:'the reason' },
    { id:'rv9_16', es:'la voz',          en:'the voice' },
    { id:'rv9_17', es:'oscuro',          en:'dark' },
    { id:'rv9_18', es:'impresionante',   en:'impressive' },
    { id:'rv9_19', es:'al fin y al cabo',en:'after all' },
    { id:'rv9_20', es:'pasado mañana',   en:'the day after tomorrow' },
  ],
};
