...
const SUBLESSON_2_2 = {
  ...
  vocabulary: [
    ...
    { id:'v2_17', es:'bonito',   en:'pretty / nice-looking',  gender:'m', rule:'ends_o',     article:'', plural:'bonitos', ex:'El patio es bonito.',        exEn:'The yard is pretty.' },
...
const SUBLESSON_2_4 = {
  ...
  vocabulary: [
    { id:'h2_1',  es:'alcoba',    en:'bedroom',         gender:'f', rule:'ends_a',    article:'la', plural:'alcobas',    ex:'Mi alcoba es azul y blanca.',      exEn:'My bedroom is blue and white.' },
    { id:'h2_2',  es:'alfombra',  en:'rug',             gender:'f', rule:'ends_a',    article:'la', plural:'alfombras',  ex:'La alfombra es roja.',             exEn:'The rug is red.' },
    { id:'h2_3',  es:'bolígrafo', en:'ballpoint pen',   gender:'m', rule:'ends_o',    article:'el', plural:'bolígrafos', ex:'El bolígrafo está en la mesa.',    exEn:'The pen is on the table.' },
    { id:'h2_4',  es:'cocina',    en:'kitchen',         gender:'f', rule:'ends_a',    article:'la', plural:'cocinas',    ex:'La cocina es amplia.',             exEn:'The kitchen is spacious.' },
    { id:'h2_5',  es:'comedor',   en:'dining room',     gender:'m', rule:'masc_irreg',article:'el', plural:'comedores',  ex:'El comedor es sencillo.',          exEn:'The dining room is simple.' },
    { id:'h2_6',  es:'cortina',   en:'curtain',         gender:'f', rule:'ends_a',    article:'la', plural:'cortinas',   ex:'Las cortinas son gruesas.',        exEn:'The curtains are thick.' },
    { id:'h2_7',  es:'cuaderno',  en:'notebook',        gender:'m', rule:'ends_o',    article:'el', plural:'cuadernos',  ex:'El cuaderno está en el estudio.',  exEn:'The notebook is in the study.' },
    { id:'h2_8',  es:'estufa',    en:'stove',           gender:'f', rule:'ends_a',    article:'la', plural:'estufas',    ex:'La estufa está limpia.',           exEn:'The stove is clean.' },
    { id:'h2_9',  es:'horno',     en:'oven',            gender:'m', rule:'masc_irreg',article:'el', plural:'hornos',     ex:'El horno está limpio.',            exEn:'The oven is clean.' },
    { id:'h2_10', es:'lápiz',     en:'pencil',          gender:'m', rule:'masc_irreg',article:'el', plural:'lápices',    ex:'El lápiz está en el cuaderno.',   exEn:'The pencil is in the notebook.' },
    { id:'h2_11', es:'nevera',    en:'refrigerator',    gender:'f', rule:'ends_a',    article:'la', plural:'neveras',    ex:'La nevera es bastante grande.',    exEn:'The refrigerator is quite big.' },
    { id:'h2_12', es:'pared',     en:'wall',            gender:'f', rule:'fem_irreg',  article:'la', plural:'paredes',    ex:'Las paredes son blancas.',         exEn:'The walls are white.' },
    { id:'h2_13', es:'patio',     en:'yard / patio',   gender:'m', rule:'ends_o',    article:'el', plural:'patios',     ex:'El patio es bonito.',              exEn:'The yard is pretty.' },
    { id:'h2_14', es:'sala',      en:'living room',     gender:'f', rule:'ends_a',    article:'la', plural:'salas',      ex:'Dos sillones están en la sala.',   exEn:'Two armchairs are in the living room.' },
    { id:'h2_15', es:'estudio',   en:'study',           gender:'m', rule:'ends_o',    article:'el', plural:'estudios',   ex:'Mis libros están en el estudio.',  exEn:'My books are in the study.' },
    { id:'h2_16', es:'vestíbulo', en:'entryway',        gender:'m', rule:'ends_o',    article:'el', plural:'vestíbulos', ex:'Un espejo está en el vestíbulo.',  exEn:'A mirror is in the entryway.' },
