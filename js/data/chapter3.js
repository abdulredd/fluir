...
const SUBLESSON_3_4 = {
  ...
  vocabulary: [
    ...
    { id:'n3_4',  es:'coche',       en:'the car (Spain)',         gender:'m', rule:'ends_e',     article:'el', plural:'coches',     ex:'El coche es caro.',               exEn:'The car is expensive.' },
    ...
    { id:'n3_51', es:'lapicero',    en:'the ballpoint pen (Latin America)', gender:'m', rule:'ends_o',  article:'el', plural:'lapiceros',  ex:'Hay un lapicero en la mesa.',     exEn:'There is a ballpoint pen on the table.' },
    ...
    { id:'n3_53', es:'bolígrafo',   en:'the ballpoint pen (Spain)', gender:'m', rule:'ends_o',  article:'el', plural:'bolígrafos', ex:'Hay bolígrafos en la mesa.',      exEn:'There are pens on the table.' },
